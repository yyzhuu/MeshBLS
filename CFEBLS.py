...
def CFEBLS(train_x, train_y, test_x, test_y, s, c, N1, N2, N3):
    """
    CFEBLS
    """
    """
    ...
    OutputOfEnhanceLayer = np.tanh(tempOfOutputOfEnhanceLayer * parameterOfShrink)
    ...
    for i in range(N3):
        ...
        if i == 0:
            ...
            tempOfOutputOfEnhanceLayerTest_he = np.dot(tempOfOutputOfEnhanceLayerTest_he, weightOfEnhanceLayerOfCascades)
            tempOfOutputOfEnhanceLayerTest = tempOfOutputOfEnhanceLayerTest_he
    OutputOfEnhanceLayerTest = np.tanh(tempOfOutputOfEnhanceLayerTest * parameterOfShrink)
